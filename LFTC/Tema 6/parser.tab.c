...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LEFT_SHIFT = 15,                /* LEFT_SHIFT  */
  YYSYMBOL_RIGHT_SHIFT = 16,               /* RIGHT_SHIFT  */
  YYSYMBOL_CIN = 17,                       /* CIN  */
  YYSYMBOL_COUT = 18,                      /* COUT  */
  YYSYMBOL_YYACCEPT = 19,                  /* $accept  */
  YYSYMBOL_program = 20,                   /* program  */
  YYSYMBOL_21_bloc_decl_var = 21,          /* bloc-decl-var  */
  YYSYMBOL_22_lista_var = 22,              /* lista-var  */
  YYSYMBOL_23_lista_var_rest = 23,         /* lista-var-rest  */
  YYSYMBOL_24_bloc_instr = 24,             /* bloc-instr  */
  YYSYMBOL_25_bloc_instr_rest = 25,        /* bloc-instr-rest  */
  YYSYMBOL_instr = 26,                     /* instr  */
  YYSYMBOL_atribuire = 27,                 /* atribuire  */
...
{
       0,    61,    61,    64,    67,    78,    87,    90,    93,    94,
      97,    98,   101,   114,   115,   123,   133,   134,   142,   153,
     154,   157,   178
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "CONST", "INT",
  "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", "COMMA", "SEMICOLON", "LBRACE",
  "RBRACE", "LEFT_SHIFT", "RIGHT_SHIFT", "CIN", "COUT", "$accept",
  "program", "bloc-decl-var", "lista-var", "lista-var-rest", "bloc-instr",
  "bloc-instr-rest", "instr", "atribuire", "expr", "term", "operator",
  "io", YY_NULLPTR
};
...
{
       3,     8,    17,     5,    -3,   -30,     7,     9,    10,     6,
       4,    11,    -3,   -30,   -30,    20,   -30,   -30,     0,    21,
      23,   -30,   -30,    -3,     7,   -30,   -30,    -5,     1,   -30,
      15,    16,   -30,   -30,     0,     0,   -30,     0,     0,   -30,
     -30,     1,     1,   -30,   -30
};
...
{
       0,     0,     0,     0,     0,     1,     6,     0,     0,     0,
       0,     0,     9,    10,    11,     0,     4,     3,     0,     0,
       0,     2,     7,     9,     6,    19,    20,     0,    13,    16,
       0,     0,     8,     5,     0,     0,    12,     0,     0,    21,
      22,    14,    15,    17,    18
};
...
{
       8,    34,    35,    25,    26,    41,    42,    36,     6,    37,
      38,    43,    44,     3,     9,    10,     1,     5,    15,    20,
      18,    17,    19,    24,    30,    21,    31,    39,    40,    12,
       0,     0,     0,     0,     0,     0,    33,    32
};

static const yytype_int8 yycheck[] =
{
       3,     6,     7,     3,     4,    34,    35,    12,     3,     8,
       9,    37,    38,     5,    17,    18,    13,     0,    11,    15,
      10,    12,    16,     3,     3,    14,     3,    12,    12,     4,
      -1,    -1,    -1,    -1,    -1,    -1,    24,    23
};
...
{
       0,    13,    20,     5,    21,     0,     3,    22,     3,    17,
      18,    24,    26,    27,    31,    11,    23,    12,    10,    16,
      15,    14,    25,    26,     3,     3,     4,    28,    29,    30,
       3,     3,    25,    23,     6,     7,    12,     8,     9,    12,
      12,    29,    29,    30,    30
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* lista-var: ID lista-var-rest  */
#line 67 "parser.y"
                            {
                  char tmp[100];
			            strcpy(tmp, " ");
...
#line 1149 "parser.tab.c"
  ...
  case 5: /* lista-var-rest: COMMA ID lista-var-rest  */
#line 78 "parser.y"
                                       {
                  char tmp[100];
			            strcpy(tmp, " ");
...
#line 1163 "parser.tab.c"
  ...
  case 12: /* atribuire: ID ASSIGN expr SEMICOLON  */
#line 101 "parser.y"
                                   {
                char tmp[MAX];
...
#line 1211 "parser.tab.c"
  ...
  case 16: /* term: operator  */
#line 133 "parser.y"
               {(yyval.value) = (yyvsp[0].value);}
#line 1217 "parser.tab.c"
    break;

  case 17: /* term: term MUL operator  */
#line 134 "parser.y"
                        {
        char tmp[MAX];
...
#line 1230 "parser.tab.c"
  ...
  case 18: /* term: term DIV operator  */
#line 142 "parser.y"
                        {
        char tmp[MAX];
        strcpy(tmp, (yyvsp[-2].value));
...
#line 1243 "parser.tab.c"
  ...
  case 19: /* operator: ID  */
#line 153 "parser.y"
             {(yyval.value) = strdup((yyval.value));}
#line 1249 "parser.tab.c"
    break;

  case 20: /* operator: CONST  */
#line 154 "parser.y"
                {(yyval.value) = strdup((yyval.value));}
#line 1255 "parser.tab.c"
    break;

  case 21: /* io: CIN RIGHT_SHIFT ID SEMICOLON  */
#line 157 "parser.y"
                                {
        n = 0;
        strcpy(variablesRead[n], "push dword ");
        strcat(variablesRead[n], (yyvsp[-1].value));
...
#line 1281 "parser.tab.c"
  ...
  case 22: /* io: COUT LEFT_SHIFT ID SEMICOLON  */
#line 178 "parser.y"
                                   {
        ...
        strcat(sourceCode[lenSourceCode], (yyvsp[-1].value));
