...
$tipuri = @('SECVENTIALA', 'LINII', 'COLOANE', "BLOC", "DELTA_LINIAR", "DELTA_CICLIC")
$threaduri = @(@(2), @(2, 4, 8, 16), @(2, 4, 8, 16), @(2, 4, 8, 16))
$tests = @(@(10, 10, 3), @(1000, 1000, 5), @(10, 10000, 5), @(10000, 10, 5))

for ($z = 0; $z -lt $tipuri.Length; $z++) {
